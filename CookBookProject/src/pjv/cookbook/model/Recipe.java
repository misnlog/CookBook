...
public class Recipe {
    ...
    public String toString() {
        return "Recipe{" + "name=" + name + ", ingredients=" + ingredients + ", directions=" + directions + ", timeOfPreparation=" + timeOfPreparation + ", timeOfCooking=" + timeOfCooking + ", image=" + image + ", hashtags=" + hashtags + ", timeStamp=" + timeStamp + ", category=" + category + '}';
    }
